...
void loopManual() 
{
	...
	if (ts.isTouched) 
	{
		...
		else if (CurrentScreen == 9 && DSTIcon)
		{
			...
			STDST = SelectedDST;
			MySerial.println(String("ST") + "@" + STSecond + "@" + STMinute + "@" + STHour + "@" + STDay + "@" + STMonth + "@" + STYear + "@" + STDST + "@" + STTimeZone+ "@" + ST1224 + "@" + STAMPM);
		...
		{ 
			...
			MySerial.println(String("ST") + "@" + SelectedSecond + "@" + SelectedMinute + "@" + SelectedHourMilitary + "@" + SelectedDay + "@" + SelectedMonth + "@" + SelectedYear + "@" + SelectedDST + "@" + SelectedTimeZone + "@" + Selected1224 + "@" + SelectedAMPM);
